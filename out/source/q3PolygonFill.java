...
public class q3PolygonFill extends PApplet {
...
public boolean pointInside(int[] v0, int[] v1, int[] v2, List<int[]> vs){
...
public boolean checkIfCCWind(List<int[]> vs){
...
public boolean angleInBound(int[] v0, int[] v1, int[] v2, boolean ccWinding){
...
int[][][] polygons = new int[][][] {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "q3PolygonFill" };
    if (passedArgs != null) {
